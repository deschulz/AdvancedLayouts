...
public class AdvancedLayoutsActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //ListAdapter adapter = new ArrayAdapter<>(this, R.layout.simple_list_item_des, keys);

        /**
         * There are a whole bunch of canned layouts in the sdk:  android.R.layout etc
         * https://developer.android.com/reference/android/R.layout.html
         * This one is nothing more than a nicely configured TextView control
         */
        ListAdapter adapter =
    ...
    // Class<?> is a wild card:  here cls can be any class, e.g. BasicLayout.class,
    // MyListActivity.class, etc
